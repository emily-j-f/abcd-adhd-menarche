...
breast_wilcox_2 <- wilcox.test(pds_f4_p ~ adhd_diagnosis, 
                                data = wave_2_df,
                                exact = FALSE)
print("Breast development Wilcoxon Test wave 2:")
...
```{r breast development t-tests cliff's delta'}
# Baseline
cat("\n====================\nWave 0\n")
cd0 <- cliff.delta(wave_0_df$pds_f4_p ~ wave_0_df$adhd_diagnosis)
print(cd0)

# Wave 1
cat("\n====================\nWave 1\n")
cd1 <- cliff.delta(wave_1_df$pds_f4_p ~ wave_1_df$adhd_diagnosis)
print(cd1)

# Wave 2
cat("\n====================\nWave 2\n")
cd2 <- cliff.delta(wave_2_df$pds_f4_p ~ wave_2_df$adhd_diagnosis)
print(cd2)

# Wave 3
cat("\n====================\nWave 3\n")
cd3 <- cliff.delta(wave_3_df$pds_f4_p ~ wave_3_df$adhd_diagnosis)
print(cd3)
```
